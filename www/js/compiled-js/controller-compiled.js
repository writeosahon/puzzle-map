...
utopiasoftware[utopiasoftware_app_namespace].controller = {
     ...
     */
    appLifeCycleObservable: new Lifecycle({}, ["puzzle-menu:opened", "puzzle-menu:closed", "puzzle-menu:exit-clicked", "puzzle-menu:puzzle-levels-clicked", "puzzle-menu:background-music-clicked", "puzzle-menu:sound-effects-clicked", "puzzle-menu:puzzle-hints-clicked", "app:will-exit", "app:no-exit", "app:exited", "app:will-load-page", "app:no-load-page", "app:loaded-page"], {
    ...
    puzzleLevelsPageViewModel: {
        ...
        loadPuzzleLevel: function () {
            var _ref16 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16(levelNumber) {
        ...
        backgroundMusicSwitchClickedListener: function () {
            var _ref17 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee17(eventArgs) {
                var event;
        ...
        soundEffectsSwitchClickedListener: function () {
            var _ref18 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee18(eventArgs) {
                var event;
            ...
            function soundEffectsSwitchClickedListener(_x3) {
    ...
    puzzlePageViewModel: {
                        ...
                        while (1) {
                            switch (_context19.prev = _context19.next) {
                                ...
                                case 3:
                                    ...
                                    utopiasoftware[utopiasoftware_app_namespace].controller.appLifeCycleObservable.on("app:will-load-page", utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.appWillLoadPageListener);
                                ...
                                case 17:
                                    ...
                                    utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.puzzlePieceDimension = puzzlePieceDimension;
                                    ...
                                    utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.draggableDroppableObject.on("droppable:start", function (droppableStartEvent) {
                                        ...
                                        if (!utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.dragStartContainer.is('.puzzle-pieces-tray')) {
                                            ...
                                            // initial container is a 'puzzle-pieces' tray
                                            ...
                                            var puzzleTraySlotValue = utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.dragStartContainer.attr('data-puzzle-tray-slot');

                                            // remove all puzzle animations from the tray container
                                            $(".puzzle-drop-zone.puzzle-pieces-tray[data-puzzle-tray-slot=\"" + puzzleTraySlotValue + "\"]", $thisPage).removeClass("animated flash");
                                        }
                                    });
                                    ...
                                    utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.draggableDroppableObject.on("droppable:stop", function (droppableStopEvent) {
                                        ...
                                        if (utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.dragStartContainer.puzzleDropped === true && utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.dragStartContainer.puzzleStartDropStamp === utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.dragStartContainer.puzzleDroppedStamp) {
                                            ...
                                            if (utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.dragStartSource.attr('data-puzzle-slot') == puzzleSlotValue) {
                                                ...
                                                window.setTimeout(utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.checkAnswerSheet, 0);
                                            } else {
                                                // check if user wants puzzle-hints
                                                if (utopiasoftware[utopiasoftware_app_namespace].model.gameSettings.puzzleHintsOn === true) {
                                            ...
                                            // this is NOT a valid puzzle movement
                                            ...
                                            if (!utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.dragStartContainer.is('.puzzle-pieces-tray') && $(droppableStopEvent.dropzone).is('.puzzle-pieces-tray')) {
                                                ...
                                                utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.puzzleAnswerSheetMap.set(utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.dragStartContainer.attr('data-puzzle-slot'), false);
                                            }
                                        }
                                    });
                                    ...
                                    utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.draggableDroppableObject.on("droppable:stop", function (droppableStopEvent) {
                                        ...
                                        if (utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.dragStartContainer.puzzleDropped === true && utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.dragStartContainer.puzzleStartDropStamp === utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.dragStartContainer.puzzleDroppedStamp) {
                                            ...
                                            if (utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.dragStartContainer.is('.puzzle-pieces-tray')) {
                                                // this is a puzzle-pieces tray

                                                // work in a separate event queue
                                                window.setTimeout(function () {
                                                    // find a puzzle-pieces tray that is NOT occupied AND NOT the spare 3rd slot
                                                    var emptyPuzzlePieceTray = $('#puzzle-page .puzzle-pieces-tray').get().find(function (arrayElem) {
                                                    ...
                                                    if (emptyPuzzlePieceTray) {
                                                        // an empty puzzle-pieces tray which fits the criteria was found
                                                        // add a new puzzle piece to the tray
                                                        utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.addPuzzlePiece($(emptyPuzzlePieceTray).attr("data-puzzle-tray-slot"));
                                                    }
                    ...
                    while (1) {
                        switch (_context20.prev = _context20.next) {
                            case 0:
                                ...
                                utopiasoftware[utopiasoftware_app_namespace].controller.appLifeCycleObservable.on("puzzle-menu:sound-effects-clicked", utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.soundEffectsSwitchClickedListener);
                    ...
                    while (1) {
                        switch (_context21.prev = _context21.next) {
                            case 0:
                                ...
                                utopiasoftware[utopiasoftware_app_namespace].controller.appLifeCycleObservable.off("puzzle-menu:sound-effects-clicked", utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.soundEffectsSwitchClickedListener);
                    ...
                    while (1) {
                        switch (_context22.prev = _context22.next) {
                            ...
                            case 5:
                                ...
                                utopiasoftware[utopiasoftware_app_namespace].controller.appLifeCycleObservable.off("app:will-load-page", utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.appWillLoadPageListener);
                                ...
                                utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.puzzlePieceDimension = 0;
                                // flag that puzzle has NOT been completed
                                utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.puzzleCompleted = false;
        ...
        puzzleTimerPausedListener: function () {
            var _ref24 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee24(timer) {
            ...
            function puzzleTimerPausedListener(_x4) {
         ...
         * @returns {Promise<void>}
         */
        addPuzzlePiece: function () {
            var _ref26 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee26(puzzleTraySlot) {
                var puzzlePiecesTray, puzzleAnswerPiece;
                return regeneratorRuntime.wrap(function _callee26$(_context26) {
                    while (1) {
                        switch (_context26.prev = _context26.next) {
                            case 0:
                                if (!(utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.puzzleImageAssetsMap.get("puzzle-answer-pieces").length === 0)) {
                                    _context26.next = 2;
                                    break;
                                }
                            ...
                            case 2:
                                ...
                                puzzlePiecesTray = $("#puzzle-page .puzzle-pieces-tray[data-puzzle-tray-slot=\"" + puzzleTraySlot + "\"]").eq(0);
                                ...
                                utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.draggableDroppableObject.removeContainer(puzzlePiecesTray.get(0));
                                ...
                                utopiasoftware[utopiasoftware_app_namespace].controller.puzzlePageViewModel.draggableDroppableObject.addContainer(puzzlePiecesTray.get(0));
            ...
            function addPuzzlePiece(_x5) {
                return _ref26.apply(this, arguments);
            }

            return addPuzzlePiece;
        }(),
                    ...
                    while (1) {
                        switch (_context31.prev = _context31.next) {
                            case 0:
                                ...
                                if (event.isCanceled !== true && event.pageIdToLoad === "puzzle-levels-page") {
